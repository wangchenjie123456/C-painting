...
namespace luxintao
{
    ...
    class ToolUtils
    {
         ...
         * 浮雕效果
         * **/
        public static Bitmap fudiao(int Width,int Height,Bitmap oldBitmap){
         ...
         * 黑白效果
         * **/
        public static Bitmap heibaixiaoguo(int temp_Width,int temp_Height, Bitmap oldBitmap){
        ...
        public static Bitmap rouhuaxiaoguo(int temp_Width, int temp_Height, Bitmap oldBitmap)
        {
        ...
        public static Bitmap ruihua(int temp_Width, int temp_Height, Bitmap oldBitmap)
        {
            Bitmap newBitmap = new Bitmap(temp_Width, temp_Height);
            Color pixel;
            //拉普拉斯模板
         ...
         * 灰度
         * **/
        public static Bitmap huidu(Bitmap currentBitmap)
        {
         ...
         * 雾化效果
         * **/
        public static Bitmap wuhuaxiaoguo(int temp_Width, int temp_Height, Bitmap oldBitmap)
        {
            Bitmap newBitmap = new Bitmap(temp_Width, temp_Height);
            Color pixel;
            for (int x = 1; x < temp_Width - 1; x++)
         ...
         * 马赛克
         * **/
        public static Bitmap masaike(Bitmap m_PreImage, int val)
        {
