...
namespace luxintao
{
    public partial class form1 : Form
    {
        ...
        private void 图像大小设置ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            setsize_form sizeForm = new setsize_form();
            sizeForm.Owner = this;
            sizeForm.ShowDialog();
        ...
        private void 浮雕ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Bitmap newBitmap = ToolUtils.fudiao(Width, Height, oldBitmap);
                img = newBitmap;
        ...
        private void 黑白ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Bitmap oldBitmap = (Bitmap)this.pictureBox1.Image;
                Bitmap newBitmap = ToolUtils.heibaixiaoguo(temp_Width, temp_Height, oldBitmap);
                img = newBitmap;
                this.pictureBox1.Image = newBitmap;
                pictureBox1.SizeMode = PictureBoxSizeMode.AutoSize;
            }
        ...
        private void 柔化ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int temp_Height = this.pictureBox1.Image.Height;
                Bitmap oldBitmap = (Bitmap)this.pictureBox1.Image;
                Bitmap newBitmap = ToolUtils.rouhuaxiaoguo(temp_Width, temp_Height, oldBitmap);
                img = newBitmap;
                this.pictureBox1.Image = newBitmap;
                pictureBox1.SizeMode = PictureBoxSizeMode.AutoSize;
            }
        ...
        private void 锐化ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int temp_Height = this.pictureBox1.Image.Height;
                Bitmap oldBitmap = (Bitmap)this.pictureBox1.Image;
                Bitmap newBitmap = ToolUtils.ruihua(temp_Width, temp_Height, oldBitmap);
                img = newBitmap;
                this.pictureBox1.Image = newBitmap;
                pictureBox1.SizeMode = PictureBoxSizeMode.AutoSize;
            }
        ...
        private void 灰度化ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int temp_Height = this.pictureBox1.Image.Height;
                Bitmap oldBitmap = (Bitmap)this.pictureBox1.Image;
                Bitmap newBitmap = ToolUtils.huidu(oldBitmap);
                img = newBitmap;
                this.pictureBox1.Image = newBitmap;
                pictureBox1.SizeMode = PictureBoxSizeMode.AutoSize;
            }
        ...
        private void 雾化ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int temp_Height = this.pictureBox1.Image.Height;
                Bitmap oldBitmap = (Bitmap)this.pictureBox1.Image;
                Bitmap newBitmap = ToolUtils.wuhuaxiaoguo(temp_Width, temp_Height, oldBitmap);
                img = newBitmap;
                this.pictureBox1.Image = newBitmap;
                pictureBox1.SizeMode = PictureBoxSizeMode.AutoSize;
            }
        ...
        private void 马赛克效果ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int temp_Height = this.pictureBox1.Image.Height;
                Bitmap oldBitmap = (Bitmap)this.pictureBox1.Image;
                Bitmap newBitmap = ToolUtils.masaike(oldBitmap, 6);
                img = newBitmap;
                this.pictureBox1.Image = newBitmap;
                pictureBox1.SizeMode = PictureBoxSizeMode.AutoSize;
            }
        ...
        {
            SetGradient_Form grand = new SetGradient_Form();
            grand.Owner = this;
            grand.ShowDialog();
            if (colortype == 2)
            {
        ...
        {
            sethatch_form sh = new sethatch_form();
            sh.Owner = this;
            sh.ShowDialog();
            if (colortype == 3)
            {
